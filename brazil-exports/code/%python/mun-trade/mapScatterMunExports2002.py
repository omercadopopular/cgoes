...
PCEnom = PCEFrame.loc[ PCEFrame['CO_ANO'] == 2002 , 'PCE' ]
...
#plt.suptitle('Brazil: Distribution of Exports per Person, 2002', fontsize=32)
#plt.title('(In US$2022, FOB per person; bubbles portional to total municipal exports)', fontsize=22)
plt.ylim(-5000,135000)

plt.savefig(os.path.join(OutPath, 'mun_scatter2002.png'))
plt.savefig(os.path.join(OutPath, 'mun_scatter2002.pdf'))
plt.savefig(os.path.join(OutPath, 'mun_scatter2002.eps'))
plt.show()
...
plt.savefig(os.path.join(OutPath, 'mun_scatter2002zoom.png'))
plt.savefig(os.path.join(OutPath, 'mun_scatter2002zoom.pdf'))
plt.savefig(os.path.join(OutPath, 'mun_scatter2002zoom.eps'))
plt.show()



Complete.to_csv(r'C:\Users\wb592068\OneDrive - WBG\Brazil\data\trade-processed\munExportsperCapita2002.csv')
...
plt.tight_layout()
plt.savefig(os.path.join(OutPath, 'mun_mappc2002.png'))
plt.savefig(os.path.join(OutPath, 'mun_mappc2002.pdf'))
plt.savefig(os.path.join(OutPath, 'mun_mappc2002.eps'))
plt.show()
