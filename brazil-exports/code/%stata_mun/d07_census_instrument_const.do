...
bysort mun_code isic3code3d: egen LaborShr2000 = mean(t_LaborShr2000)
...
// reshape 
reshape wide vl_fob vl_fobr pce adj, i(iso3code isic3code3d ufCode) j(year)
...
collapse (sum) gGDPcont g2GDPcont dGDPcont, by(ufCode isic3code3d)
...
collapse (sum) giv g2iv, by(year ufCode mun_code)
