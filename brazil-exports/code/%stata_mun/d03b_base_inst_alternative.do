...
collapse (sum) givbase_comtrade g2ivbase_comtrade, by(year ufCode mun_code)
...
merge 1:1 year ufCode mun_code using "data\temp\mun-trade-panel-inst-base.dta"
drop _merge


merge 1:1 year ufCode mun_code using "data\temp\mun-trade-panel-processed.dta"
drop _merge

save "data\temp\mun-trade-panel-processed-base.dta", replace
