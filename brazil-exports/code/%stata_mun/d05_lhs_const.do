...
gen wage_mass_less_than_college = wage_mass - wage_mass_college_or_higher
...
label var mun_code "Municipality, IBGE code"
...
label var w_less_than_college "Average wage, less than college, current R$, RAIS"
label var w_college_or_higher "Average wage, college or higher education, current R$, RAIS"

label var avg_wage_q1r "Average real wage, mun quartile 1"
label var avg_wage_q2r "Average real wage, mun quartile 2"
label var avg_wage_q3r "Average real wage, mun quartile 3"
label var avg_wage_q4r "Average real wage, mun quartile 4"

label var avg_wage_q1 "Average wage, mun quartile 1"
label var avg_wage_q2 "Average wage, mun quartile 2"
label var avg_wage_q3 "Average wage, mun quartile 3"
label var avg_wage_q4 "Average wage, mun quartile 4"

label var avg_wage_h1r "Average real wage, mun half 1"
label var avg_wage_h2r "Average real wage, mun half 2"

label var avg_wage_h1 "Average wage, mun half 1"
label var avg_wage_h2 "Average wage, mun half 2"

// mdic
label var vl_fob "Exports by mun, nominal $, MDIC"
label var vl_fobr "Exports by mun, constant $2022, MDIC (Deflated with PCE, FRED)"
label var gvl_fobr "Pct Change in Exports by mun, constant $2022, MDIC (Deflated with PCE, FRED)"
...
compress 
save "data\temp\mun-master-dataset.dta", replace
*erase "data\temp\mun-trade-panel-processed-exp.dta"
