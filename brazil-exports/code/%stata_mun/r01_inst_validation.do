...
outreg using "results\mun-first-stage.doc", se sdec(3) ///
...
graph export "figs\mun-first-stage.pdf", as(pdf) replace
graph export "figs\mun-first-stage.wmf", as(wmf) replace

reghdfe gvl_fob giv_comtrade
outreg using "results\mun-first-stage-comtrade.doc", se sdec(3) ///
	summstat(r2 \ N) summdec(1,0) summtitles("R2" \ "N") ///
	starlevels(10 5 1) starloc(1) ///
	ctitles("", "Full Sample" \ "", "") ///
...
graph export "figs\mun-first-stage-comtrade.pdf", as(pdf) replace
graph export "figs\mun-first-stage-comtrade.wmf", as(wmf) replace
...
twoway (hist giv, color(red%50) percent) (hist giv_comtrade, color(blue%50) percent), ///
	...
	xtitle("") 
graph export "figs\mun-iv-hist.pdf", as(pdf) replace
graph export "figs\mun-iv-hist.wmf", as(wmf) replace
...
graph export "figs\mun-first-stage-ivs.pdf", as(pdf) replace
graph export "figs\mun-first-stage-ivs.wmf", as(wmf) replace
