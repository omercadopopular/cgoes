...
preserve
	collapse (mean) avg_wage_tot avg_wage_man_tot avg_wage_less_than_pri_tot avg_wage_primary_tot avg_wage_secondary_tot avg_wage_college_tot avg_wage_q1_tot avg_wage_q2_tot avg_wage_q3_tot avg_wage_q4_tot, by(year ufCode mun_code_ibge isic3code3d )
...
keep if year == 2010
keep ufCode mun_code_ibge year g* base_*
