...
var y c k i n w r gc tauk gi gk;  
...
parameters taun deltag theta varphi;  
parameters ky_ss iy_ss cy_ss gcy_ss gc_ss n_ss y_ss r_ss varphi_ss varphiy_ss w_ss giy_ss gky_ss gi_ss gk_ss tauk_ss;
...
tauk_ss = .05; // from previous models 

r_ss = ( (1-beta*(1-(1-tauk_ss)*delta)) / ((1-tauk_ss)*beta) ); // SS interest rate
...
tauk_ss = (-taun*(1-alpha) + giy_ss + gcy_ss + varphiy_ss)/((r_ss-delta)*ky_ss); // labor-tax transfers
