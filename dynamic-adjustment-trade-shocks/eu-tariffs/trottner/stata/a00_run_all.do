...
cd "/main/tradeadj/lev/"

* SET ADO plus folder

sysdir set PLUS "/main/tradeadj/lev/teti_code/ado/"
...
di "$S_DATE $S_TIME"
do "./teti_code/d01_BACI_clean_data.do"
...
di "$S_DATE $S_TIME"
do "./teti_code/d02_TRAINS_clean_data.do"

*** Merge trade and tariff data, cleaning steps
di "$S_DATE $S_TIME"
do "./teti_code/d03_Merge_data.do"
do "./teti_code/d04_Create_partnerind.do"
do "./teti_code/d05_Create_PTA_indicator.do"

*** Create final datasets for analysis
di "$S_DATE $S_TIME"
do "./teti_code/d06_Create_datanalysis_dataset.do"
do "./teti_code/d07_Create_datanalysis.do"
do "./teti_code/d08_Create_datanalysis_all.do"

*** Create data for robustness checks
do "./teti_code/d09_Create_PTA_indicator_robustness.do"
do "./teti_code/d10_merge_ttb.do"
do "./teti_code/d11_pwt.do"
do "./teti_code/d12_convert_ossa_GTAP.do"
do "./teti_code/d13_wiod_sectors.do"
