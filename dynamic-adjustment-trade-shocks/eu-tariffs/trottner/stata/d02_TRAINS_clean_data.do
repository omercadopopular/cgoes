...
////////////////////////
// CG - define auxiliar program for label transformations
////////////////////////
...
global varLabel "NativeNomen Reporter ReporterName Product Partner PartnerName TradeSource DutyType"
...
forvalues year=1995/2018 {
	...
	*Open database.
	use NativeNomen Partner Reporter ReporterName PartnerName Product TariffYear TradeYear DutyType SimpleAverage ImportsValuein1000USD StandardDeviation TradeSource SpecificDutyImportsin1000USD using "./data/TRAINS/TRAINS`year'.dta", clear
	
	foreach var of global varLabel {
		delabel `var'
	}
	...
	*Erase files.
*	erase "./data/TRAINS/TRAINS`year'.dta"
