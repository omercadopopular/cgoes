...
cap log close
log using "./output/logs/log_r07b.smcl", append
...
*Fixed effects.
local fe fe_imp_hs4_yr fe_exp_hs4_yr
		...
		foreach lhs of local outcomes{
			...
			*Define matrix to store results.
			...
			forvalues h = 0 (1) `post'{
				...
				*Save results.
				xsvmat elasticity_`lhs', name(col) saving("./output/temp_files/`iv'_elasticity_`lhs'_l`l'_bfe_no.dta", replace)
...
*Fixed effects.
local fe fe_imp_hs4_yr fe_exp_hs4_yr fe_imp_exp
		...
		foreach lhs of local outcomes{
			...
			*Define matrix to store results.
			...
			forvalues h = 0 (1) `post'{
				...
				*Save results.
				xsvmat elasticity_`lhs', name(col) saving("./output/temp_files/`iv'_elasticity_`lhs'_l`l'_bfe.dta", replace)
				xsvmat elasticity_`lhs', name(col) list(,)
...
*Fixed effects.
local fe fe_imp_hs4_yr fe_exp_hs4_yr fe_imp_exp_hs2
		...
		foreach lhs of local outcomes{
			...
			*Define matrix to store results.
			...
			forvalues h = 0 (1) `post'{
				...
				*Save results.
				xsvmat elasticity_`lhs', name(col) saving("./output/temp_files/`iv'_elasticity_`lhs'_l`l'_bfe_hs2.dta", replace)
				xsvmat elasticity_`lhs', name(col) list(,)
...
*Fixed effects.
local fe fe_imp_hs4_yr fe_exp_hs4_yr fe_imp_exp_hs3
		...
		foreach lhs of local outcomes{
			...
			*Define matrix to store results.
			...
			forvalues h = 0 (1) `post'{
				...
				*Save results.
				xsvmat elasticity_`lhs', name(col) saving("./output/temp_files/`iv'_elasticity_`lhs'_l`l'_bfe_hs3.dta", replace)
				xsvmat elasticity_`lhs', name(col) list(,)
