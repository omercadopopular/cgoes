% Policy experiment 4: Consider tariff changes for one importer
% on goods from all sector and vis-a-vis all exporters
...
for dest_c=1:N
    ...
    save(strcat('../../temp_files/',string(country_names(dest_c)),'allcntrs_allsec_',filename),'irfs')
