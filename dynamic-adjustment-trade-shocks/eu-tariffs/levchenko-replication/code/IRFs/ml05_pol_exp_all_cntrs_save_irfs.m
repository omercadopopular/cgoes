% Policy experiment 3: Consider tariff changes for one importer
% of goods on one sector and vis-a-vis all exporters
...
for dest_c=1:N
    ...
    save(strcat('../../temp_files/',string(country_names(dest_c)),'all_cntrs_',filename),'irfs')
