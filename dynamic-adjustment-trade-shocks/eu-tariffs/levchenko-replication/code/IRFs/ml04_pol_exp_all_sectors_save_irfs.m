% Policy experiment 2: Consider tariff changes for one importer
% of goods on all sectors and vis-a-vis an individual exporter

%=========================================================================% 
% tariff change in all sectors: plot individual impulse response functions
%=========================================================================% 
...
for dest_c=1:N
    ...
    save(strcat('../../temp_files/',string(country_names(dest_c)),'all_sectors_',filename),'irfs')
