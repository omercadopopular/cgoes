...
%%
%%% Part 1 %%%
load ../../temp_files/CANind_irfs_sig1p10_chi0p82
...
load ../../temp_files/CANind_irfs_sig3p00_chi1p00
...
load ../../temp_files/CANall_sectors_irfs_sig1p10_chi0p82
...
load ../../temp_files/CANall_sectors_irfs_sig3p00_chi1p00
...
load ../../temp_files/CANall_cntrs_irfs_sig1p10_chi0p82
...
load ../../temp_files/CANall_cntrs_irfs_sig3p00_chi1p00
...
lgd = legend('Baseline calibration, PE response', ...
    'Baseline calibration, GE range CAN', ...
    'High elasticity, PE response',...
    'High elasticity, GE range CAN',...
...
load ../../temp_files/CANallcntrs_allsec_irfs_sig1p10_chi0p82
...
load ../../temp_files/CANallcntrs_allsec_irfs_sig3p00_chi1p00
...
print(figure(1),'-dpng','-r600',strcat('../../output/graphs/final_files/fig_all4_','CAN','.png'))
print(figure(1),'-depsc','-r600',strcat('../../output/graphs/final_files/fig_all4_','CAN','.eps'))
