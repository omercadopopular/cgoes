...
# Run code
stata-mp -b ./code/g01_crosswalk_a.do

# Run code
stata-mp -b ./code/r01_regressions_baseline_int.do

# Run code
stata-mp -b ./code/r05_regressions_robustness_21sec.do

# Run code
stata-mp -b ./code/r07_regressions_graphs_a.do