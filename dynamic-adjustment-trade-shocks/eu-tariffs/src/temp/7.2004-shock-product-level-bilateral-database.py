...
Folder = r'C:\Users\Carlos\OneDrive - UC San Diego\UCSD\Research\product-innovation-trade\data\wits'
os.chdir(Folder)
...
ax.hist(HistFrame['DeltaTau_04'], bins = 100,
    ...
    # Title and labels
ax.set_title('Distribution of Tariff Changes in 2004 \n (non-zero changes)', size = 26)
ax.set_xlabel(r'$\Delta \tau_{sdip,2004}$, in percentage points', size = 22)
plt.axvline(0, color='black')

plt.tight_layout()
plt.show()
        
fig.savefig('out-img/2004_delta_tau.pdf')
