...
#InFolder = r'C:\Users\wb592068\OneDrive - UC San Diego\UCSD\Research\data\wits\out\yearly-pref'
#OutFolder = r'C:\Users\wb592068\OneDrive - UC San Diego\UCSD\Research\data\wits\out\country-pref'
...
Files = Query.CountryWalker(WalkFolder=Query.YearPrefFolder)
...
for Code in CountryCodesTable.Code:
    ...
    CountryFrame.to_csv(os.path.join(Query.CountryPrefFolder, 'wits_pref_' + CodeString + '.csv'), index=False)