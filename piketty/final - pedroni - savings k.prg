...
''''' DIRECTORY SETTINGS
	...
	%wfname = "klevelssavings_test"													'Workfile name
	%filename = "fkdatabasetax.csv"										'CSV source file
	%save = "klevelssavings_test"
...
''''' DATA ADJUSTMENTS SETTINGS
	...
	%group = "rg2 savings kshare"													'Raw data to be transformed
...
'''' VAR SETTINGS
	...
	!endogenous = 3 														'Number of endogenous variables
	%cholesky	= "frg2 fsavings fkshare"												'List of endogenous VARIABLES (if needed, use log transformed data)
	%cholesky_0	= "frg2_0 fsavings_0 fkshare_0"									'Same as above, but with '_0' after variable
	%resid	= "r_frg2 r_fsavings r_fkshare"												'List of residuals
	%resid1	= "r_frg2 <> na"														'List just the first residual (this is used for bootstrapping
	!maxlags = 1															'Number of lags in VAR
...
'''' BOOTSTRAP SEETINGS
	...
	!boot = 0 																	'Perform bootstrapping procedure? YES = 1
