...
fig_moments.savefig(os.path.join(figs_path, 'moments_k.pdf'))
...
fig_decomp.savefig(os.path.join(figs_path, 'decomp_k.pdf'))
...
fig_se.savefig(os.path.join(figs_path, 'median_se_k.pdf'))
