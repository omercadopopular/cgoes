...
fig_moments.savefig(os.path.join(figs_path, 'moments_base.pdf'))
...
fig_decomp.savefig(os.path.join(figs_path, 'decomp_base.pdf'))
...
fig_se.savefig(os.path.join(figs_path, 'median_se_base.pdf'))
