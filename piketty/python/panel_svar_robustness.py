...
for var in ['rg1', 'rg2', 'rg3', 'rg4']:
    ...
    moments_mat_baseline, median_mat_baseline, average_mat_baseline, pctiles = panel_var.collect_moments(irfs)
    
    medians_l.append(median_mat_baseline[1,0])
...
medians_l.append(median_mat_baseline[0,1])
...
medians_r = []
for var in ['rg1', 'rg2', 'rg3', 'rg4', 'rg5']:
    # Initialize the PanelVAR class
    panel_var = PanelVAR(data, idx_col='country', time_col='year', horizon=20)
    
    # Variables to analyze (obeying cholesky order)
    variables = [var, 'savings', 'kshare']
    ...
    medians_r.append(median_mat_baseline[2,0])

variables = ['kshare', 'savings', 'rg1']
...
ax[0].plot(medians_l[0], 'o-', label="Baseline", color='red')
ax[0].plot(medians_l[1], '*-', label="No taxes", color='navy')
ax[0].plot(medians_l[2], '+-', label="Short-term yields", color='yellow')
ax[0].plot(medians_l[3], 'x-', label="Implied r", color='purple')
ax[0].plot(medians_l[4], '^-', label="Inverted cholesky order", color='teal')
ax[0].axhline(y=0, color='black')
ax[0].set_title("Shock: (r-g). Response: Share of top 1%.")
ax[0].grid(True)

ax[1].plot(medians_r[0], 'o-', label="Baseline", color='red')
ax[1].plot(medians_r[1], '*-', label="No taxes", color='navy')
ax[1].plot(medians_r[2], '+-', label="Short-term yields", color='yellow')
ax[1].plot(medians_r[3], 'x-', label="Implied r", color='purple')
ax[1].plot(medians_r[4], '^-', label="Inverted cholesky order", color='teal')
ax[1].axhline(y=0, color='black')
ax[1].set_title("Shock: (r-g). Response: Capital share.")
ax[1].grid(True)
...
fig.savefig(os.path.join(figs_path, 'robustness.pdf'))
