...
def rais_decoder(FILE,
    ...
    READER = pd.read_csv(FILE, sep=';', decimal=',', chunksize=10000, encoding='latin1')
...
# Salvar resultado
df.to_csv('H:\\Notas Conceituais\\SegPub-Drogas\\Dados\\results\\rais_consolidado.csv',
          sep=";", decimal=",")
df.to_excel('H:\\Notas Conceituais\\SegPub-Drogas\\Dados\\results\\rais_consolidado.xlsx')